              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <address>
                      <p className="font-weight-bold">Friends</p>
                      <p> The Chinese University of Hong Kong, Central Ave </p>
                    </address>
                  </div>
                  <div className="col-md-6">
                    <address className="text-primary">
                      <p className="font-weight-bold"> E-mail </p>
                      <p className="mb-2"> 1155148699@link.cuhk.edu.hk </p>
                      <p className="font-weight-bold"> Web Address </p>
                      <p> https://proj.cse.cuhk.edu.hk/csci3100/ </p>
                    </address>
                  </div>
                </div>
              </div>
